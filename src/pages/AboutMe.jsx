      ...
      <div className="about-container">
        ...
        <div className="hero">
          ...
          <div className="hero-text">
            ...
            <p className="intro">
              <strong>사용자 경험을 구현하는 프론트엔드 개발자, 한민지입니다.</strong>
              <br/>
              <strong>React</strong>를 중심으로 <strong>커뮤니티, 쇼핑몰, 할일 앱 등 3개의 프로젝트를 
              기획부터 배포까지 완성</strong>했습니다.
              <br/>
              "왜 이렇게 만들었을까?"보다 <strong>"이렇게 하면 더 편하겠다"</strong>를 먼저 생각합니다.
              <br/>
              사용자의 관점에서 불필요한 단계를 줄이고, <strong>직관적인 흐름과 경험</strong>을 만드는 데 집중합니다.
            </p>
          </div>
        </div>
